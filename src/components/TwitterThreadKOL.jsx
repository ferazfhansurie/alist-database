...
const TwitterThreadKOL = () => {
  ...
  useEffect(() => {
    ...
    const twitterKOLs = sampleKOLData.filter(kol => kol.kolType === KOL_TYPES.TWITTER_THREAD);
              ...
              <Box mb={4}>
                <InputGroup size="lg">
                  ...
                  <Input
                    ...
                    borderRadius="xl"
                    placeholder="🔍 Search Twitter/Thread KOLs by name, contact, niche, or platform..."
                    value={searchTerm}
