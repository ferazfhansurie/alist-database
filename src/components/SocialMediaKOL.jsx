                ...
                <Tbody>
                  {filteredData.map((kol) => (
                    ...
                    >
                      {/* KOL Details */}
                      <Td px={6} py={5}>
                        <VStack align="start" spacing={3} maxH="80px" overflow="hidden">
                          ...
                          <HStack spacing={3} flexWrap="wrap">
                            {kol.instagram && (
                              ...
                              >
                                ...
                                <Text fontSize="sm" color="blue.600" fontWeight="600">IG</Text>
                              </HStack>
                            )}
                            {kol.tiktok && (
                              <HStack 
                                ...
                                boxShadow="0 2px 8px rgba(0,0,0,0.1)"
                              >
                                <Text fontSize="sm" color="black" fontWeight="600">🎵</Text>
                                <Text fontSize="sm" color="blue.600" fontWeight="600">TT</Text>
                              </HStack>
                            )}
                          </HStack>
                        </VStack>
