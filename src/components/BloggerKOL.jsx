...
const BloggerKOL = () => {
  ...
  useEffect(() => {
    ...
    const bloggerKOLs = sampleKOLData.filter(kol => kol.kolType === KOL_TYPES.BLOGGER);
              ...
              {viewingKOL && (
                <VStack spacing={4} align="stretch">
                  ...
                  <Box 
                    ...
                    borderColor="rgba(255, 255, 255, 0.2)"
                  >
                    <Text fontWeight="700" color="gray.700" mb={2}>Blog URL:</Text>
                    <Text color="blue.500" cursor="pointer" onClick={() => openLink(viewingKOL.blog)}>
                      {viewingKOL.blog}
                    </Text>
                  </Box>
                  <Box 
