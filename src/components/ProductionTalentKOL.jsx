...
const ProductionTalentKOL = () => {
  ...
  useEffect(() => {
    ...
    const productionKOLs = sampleKOLData.filter(kol => kol.kolType === KOL_TYPES.PRODUCTION_TALENT);
              ...
              <Box mb={4}>
                <InputGroup size="lg">
                  ...
                  <Input
                    ...
                    borderRadius="xl"
                    placeholder="🔍 Search Production Talents by name, contact, niche, or type..."
                    value={searchTerm}
              ...
              {viewingKOL && (
                <VStack spacing={4} align="stretch">
                  ...
                  <Box 
                    ...
                    borderColor="rgba(255, 255, 255, 0.2)"
                  >
                    <Text fontWeight="700" color="gray.700" mb={2}>Talent Type:</Text>
                    <HStack>
                      {getTalentTypeIcon(viewingKOL.niches)}
                      <Badge colorScheme="purple">
                        {getTalentTypeLabel(viewingKOL.niches)}
                      </Badge>
                    </HStack>
                  </Box>
                  <Box 
